...
public class CalculatorPadLayout extends ViewGroup {
    ...
    public CalculatorPadLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, new int[]{
                android.R.attr.rowCount, android.R.attr.columnCount}, defStyle, 0);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int childIndex = 0; childIndex < getChildCount(); ++childIndex) {
            ...
            final int childLeft = paddingLeft + lp.leftMargin + (isRTL ? (mColumnCount - 1) - columnIndex : columnIndex) * columnWidth;
